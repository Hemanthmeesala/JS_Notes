...
console.log(Array.isArray("hk")); // check given value is an array or not
console.log(Array.from("hemanth")); // split into multiple array elements
console.log(Array.from({name: "hemanth"}));
